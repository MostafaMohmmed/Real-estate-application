...
import 'edit_property_page.dart'; // تأكد من وجود الصفحة كما في الكود السابق
...
class _CompanyHomePageState extends State<CompanyHomePage>
  ...
  /// يحوّل أي نوع خام للصورة إلى Uint8List (يدعم Blob/Uint8List/List<int>)
  ...
  /// استريم عقارات الشركة حسب النوع
  ...
  /// إضافة إشعار للشركة
  Future<void> _addCompanyNotification({
    ...
    try {
      await FirebaseFirestore.instance
        ...
        'title': title,
        'body': body,
        'type': type, // أمثلة: Listings / Account / Security...
        'isRead': false,
        'createdAt': FieldValue.serverTimestamp(),
      });
    } catch (e) {
      debugPrint('⚠️ Failed to add company notification: $e');
    }
  }
  ...
  Widget build(BuildContext context) {
    ...
    if (user == null) {
      // حماية لو ما في تسجيل دخول
      return Scaffold(
        appBar: AppBar(
          backgroundColor: Colors.white,
          elevation: 0,
          title:
          const Text('Company Console', style: TextStyle(color: Colors.black)),
          centerTitle: true,
        ),
        body: const Center(
          child: Text('Please sign in as a company to continue'),
        ),
      );
    }
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          // يفتح صفحة إضافة عقار (تكتب تحت companies/{uid}/properties)
          await Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => const AddPropertyPage()),
          );
          // الرجوع يعتمد على Stream للتحديث
        },
            ...
            builder: (context, snapshot) {
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  // الصورة: إمّا imageUrl أو imageBlob
                                    ...
                                    children: [
                                      ...
                                      SizedBox(
                                        ...
                                        child: IconButton(
                                          ...
                                          tooltip: 'Edit',
                                          onPressed: () async {
                                            // نمرر المرجع والبيانات الأولية لصفحة التعديل
                                            ...
                                            // لو رجعت true يعني صار تعديل
                                            if (updated == true) {
                                              _showSnack('Property updated ✔');
                                              await _addCompanyNotification(
                                                companyUid: user.uid,
                                          ...
                                          onPressed: () async {
                                            ...
                                            try {
                                              ...
                                              await _addCompanyNotification(
                                                ...
                                                body:
                                                '“$title” has been removed from your listings.',
                                                type: 'Listings',
                                              );
                                            } catch (e) {
